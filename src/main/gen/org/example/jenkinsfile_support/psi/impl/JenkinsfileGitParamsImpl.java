...
public class JenkinsfileGitParamsImpl extends ASTWrapperPsiElement implements JenkinsfileGitParams {

  public JenkinsfileGitParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitGitParams(this);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileGitOptions> getGitOptionsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileGitOptions.class);
  }
