...
public class JenkinsfileBooleanLiteralImpl extends ASTWrapperPsiElement implements JenkinsfileBooleanLiteral {

  public JenkinsfileBooleanLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
