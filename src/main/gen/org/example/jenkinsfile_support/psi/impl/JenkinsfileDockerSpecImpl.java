...
public class JenkinsfileDockerSpecImpl extends ASTWrapperPsiElement implements JenkinsfileDockerSpec {

  public JenkinsfileDockerSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitDockerSpec(this);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileDockerOptions> getDockerOptionsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileDockerOptions.class);
  }
