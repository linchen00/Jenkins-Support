...
public class JenkinsfileDockerfileOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileDockerfileOptions {

  public JenkinsfileDockerfileOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitDockerfileOptions(this);
  }
