...
public class JenkinsfilePowerExpressionImpl extends ASTWrapperPsiElement implements JenkinsfilePowerExpression {

  public JenkinsfilePowerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileUnaryExpression> getUnaryExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileUnaryExpression.class);
  }
