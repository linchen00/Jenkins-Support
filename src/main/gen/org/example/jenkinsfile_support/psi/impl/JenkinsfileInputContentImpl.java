...
public class JenkinsfileInputContentImpl extends ASTWrapperPsiElement implements JenkinsfileInputContent {

  public JenkinsfileInputContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitInputContent(this);
  }
