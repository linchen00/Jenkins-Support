...
public class JenkinsfileUpstreamParamsImpl extends ASTWrapperPsiElement implements JenkinsfileUpstreamParams {

  public JenkinsfileUpstreamParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitUpstreamParams(this);
  }
  ...
  @Override
  @NotNull
  public JenkinsfileThresholdValue getThresholdValue() {
    return findNotNullChildByClass(JenkinsfileThresholdValue.class);
  }
