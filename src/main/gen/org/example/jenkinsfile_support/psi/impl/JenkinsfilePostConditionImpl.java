...
public class JenkinsfilePostConditionImpl extends ASTWrapperPsiElement implements JenkinsfilePostCondition {

  public JenkinsfilePostConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JenkinsfilePostConditionType getPostConditionType() {
    return findNotNullChildByClass(JenkinsfilePostConditionType.class);
  }
