...
public class JenkinsfileKubernetesOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileKubernetesOptions {

  public JenkinsfileKubernetesOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitKubernetesOptions(this);
  }
