...
public class JenkinsfileThresholdValueImpl extends ASTWrapperPsiElement implements JenkinsfileThresholdValue {

  public JenkinsfileThresholdValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitThresholdValue(this);
  }
