...
public class JenkinsfileDockerOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileDockerOptions {

  public JenkinsfileDockerOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitDockerOptions(this);
  }
