...
public class JenkinsfileNullLiteralImpl extends ASTWrapperPsiElement implements JenkinsfileNullLiteral {

  public JenkinsfileNullLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
