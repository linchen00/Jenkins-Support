...
public class JenkinsfileAssignmentOperatorImpl extends ASTWrapperPsiElement implements JenkinsfileAssignmentOperator {

  public JenkinsfileAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
