...
public class JenkinsfileIfStatementImpl extends ASTWrapperPsiElement implements JenkinsfileIfStatement {

  public JenkinsfileIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
