...
public class JenkinsfileSecretFileParamsImpl extends ASTWrapperPsiElement implements JenkinsfileSecretFileParams {

  public JenkinsfileSecretFileParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitSecretFileParams(this);
  }
