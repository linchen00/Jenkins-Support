...
public class JenkinsfileWhileStatementImpl extends ASTWrapperPsiElement implements JenkinsfileWhileStatement {

  public JenkinsfileWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
