...
public class JenkinsfileMapLiteralImpl extends ASTWrapperPsiElement implements JenkinsfileMapLiteral {

  public JenkinsfileMapLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JenkinsfileMapEntryList getMapEntryList() {
    return findChildByClass(JenkinsfileMapEntryList.class);
  }
