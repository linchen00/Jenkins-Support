...
public class JenkinsfileGroovyCodeImpl extends ASTWrapperPsiElement implements JenkinsfileGroovyCode {

  public JenkinsfileGroovyCodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitGroovyCode(this);
  }
