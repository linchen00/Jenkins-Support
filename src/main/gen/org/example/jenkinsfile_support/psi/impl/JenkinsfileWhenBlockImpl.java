...
public class JenkinsfileWhenBlockImpl extends ASTWrapperPsiElement implements JenkinsfileWhenBlock {

  public JenkinsfileWhenBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
