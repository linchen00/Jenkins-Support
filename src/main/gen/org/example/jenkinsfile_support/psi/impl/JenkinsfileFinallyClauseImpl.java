...
public class JenkinsfileFinallyClauseImpl extends ASTWrapperPsiElement implements JenkinsfileFinallyClause {

  public JenkinsfileFinallyClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
