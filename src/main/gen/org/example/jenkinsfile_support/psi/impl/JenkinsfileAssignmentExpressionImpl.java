...
public class JenkinsfileAssignmentExpressionImpl extends ASTWrapperPsiElement implements JenkinsfileAssignmentExpression {

  public JenkinsfileAssignmentExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JenkinsfileAssignmentOperator getAssignmentOperator() {
    return findNotNullChildByClass(JenkinsfileAssignmentOperator.class);
  }
