...
public class JenkinsfileClosureParametersImpl extends ASTWrapperPsiElement implements JenkinsfileClosureParameters {

  public JenkinsfileClosureParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
