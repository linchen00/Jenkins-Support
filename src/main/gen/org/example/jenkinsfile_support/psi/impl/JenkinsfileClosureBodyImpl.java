...
public class JenkinsfileClosureBodyImpl extends ASTWrapperPsiElement implements JenkinsfileClosureBody {

  public JenkinsfileClosureBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
