...
public class JenkinsfileParameterAssignmentImpl extends ASTWrapperPsiElement implements JenkinsfileParameterAssignment {

  public JenkinsfileParameterAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
