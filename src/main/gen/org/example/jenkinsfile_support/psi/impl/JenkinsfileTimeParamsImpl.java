...
public class JenkinsfileTimeParamsImpl extends ASTWrapperPsiElement implements JenkinsfileTimeParams {

  public JenkinsfileTimeParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitTimeParams(this);
  }
