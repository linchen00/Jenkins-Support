...
public class JenkinsfileStashOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileStashOptions {

  public JenkinsfileStashOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitStashOptions(this);
  }
