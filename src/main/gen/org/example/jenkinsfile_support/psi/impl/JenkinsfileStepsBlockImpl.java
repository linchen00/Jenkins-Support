...
public class JenkinsfileStepsBlockImpl extends ASTWrapperPsiElement implements JenkinsfileStepsBlock {

  public JenkinsfileStepsBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitStepsBlock(this);
  }
