...
public class JenkinsfileAgentSimpleImpl extends ASTWrapperPsiElement implements JenkinsfileAgentSimple {

  public JenkinsfileAgentSimpleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitAgentSimple(this);
  }
