...
public class JenkinsfileParameterTypeImpl extends ASTWrapperPsiElement implements JenkinsfileParameterType {

  public JenkinsfileParameterTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
