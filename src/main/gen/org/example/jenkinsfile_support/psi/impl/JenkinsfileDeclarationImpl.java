...
public class JenkinsfileDeclarationImpl extends ASTWrapperPsiElement implements JenkinsfileDeclaration {

  public JenkinsfileDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JenkinsfileClassDeclaration getClassDeclaration() {
    return findChildByClass(JenkinsfileClassDeclaration.class);
  }

  @Override
  @Nullable
  public JenkinsfileFunctionDeclaration getFunctionDeclaration() {
    return findChildByClass(JenkinsfileFunctionDeclaration.class);
  }
