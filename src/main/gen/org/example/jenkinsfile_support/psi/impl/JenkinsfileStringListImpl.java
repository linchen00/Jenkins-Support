...
public class JenkinsfileStringListImpl extends ASTWrapperPsiElement implements JenkinsfileStringList {

  public JenkinsfileStringListImpl(@NotNull ASTNode node) {
    super(node);
  }
