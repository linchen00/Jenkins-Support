...
public class JenkinsfileMapEntryListImpl extends ASTWrapperPsiElement implements JenkinsfileMapEntryList {

  public JenkinsfileMapEntryListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileMapEntry> getMapEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileMapEntry.class);
  }
