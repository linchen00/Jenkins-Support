...
public class JenkinsfileDirStepImpl extends ASTWrapperPsiElement implements JenkinsfileDirStep {

  public JenkinsfileDirStepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitDirStep(this);
  }
