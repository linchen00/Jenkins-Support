...
public class JenkinsfileParameterImpl extends ASTWrapperPsiElement implements JenkinsfileParameter {

  public JenkinsfileParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
