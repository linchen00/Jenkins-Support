...
public class JenkinsfileCatchClauseImpl extends ASTWrapperPsiElement implements JenkinsfileCatchClause {

  public JenkinsfileCatchClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JenkinsfileParameter getParameter() {
    return findNotNullChildByClass(JenkinsfileParameter.class);
  }
