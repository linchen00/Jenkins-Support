...
public class JenkinsfileParameterOptionImpl extends ASTWrapperPsiElement implements JenkinsfileParameterOption {

  public JenkinsfileParameterOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitParameterOption(this);
  }
  ...
  public JenkinsfileStringList getStringList() {
    return findChildByClass(JenkinsfileStringList.class);
  }
