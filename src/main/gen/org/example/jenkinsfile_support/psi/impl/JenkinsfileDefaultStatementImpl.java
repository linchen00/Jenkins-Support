...
public class JenkinsfileDefaultStatementImpl extends ASTWrapperPsiElement implements JenkinsfileDefaultStatement {

  public JenkinsfileDefaultStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileStatement.class);
  }
