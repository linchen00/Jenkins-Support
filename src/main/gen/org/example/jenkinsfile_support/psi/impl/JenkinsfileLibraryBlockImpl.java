...
public class JenkinsfileLibraryBlockImpl extends ASTWrapperPsiElement implements JenkinsfileLibraryBlock {

  public JenkinsfileLibraryBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitLibraryBlock(this);
  }
