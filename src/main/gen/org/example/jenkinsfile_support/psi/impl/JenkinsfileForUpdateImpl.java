...
public class JenkinsfileForUpdateImpl extends ASTWrapperPsiElement implements JenkinsfileForUpdate {

  public JenkinsfileForUpdateImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JenkinsfileExpressionList getExpressionList() {
    return findNotNullChildByClass(JenkinsfileExpressionList.class);
  }
