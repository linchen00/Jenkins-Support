...
public class JenkinsfileCaseStatementImpl extends ASTWrapperPsiElement implements JenkinsfileCaseStatement {

  public JenkinsfileCaseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
