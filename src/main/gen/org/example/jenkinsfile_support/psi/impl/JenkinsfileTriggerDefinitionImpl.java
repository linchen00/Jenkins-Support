...
public class JenkinsfileTriggerDefinitionImpl extends ASTWrapperPsiElement implements JenkinsfileTriggerDefinition {

  public JenkinsfileTriggerDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JenkinsfileUpstreamParams getUpstreamParams() {
    return findChildByClass(JenkinsfileUpstreamParams.class);
  }
