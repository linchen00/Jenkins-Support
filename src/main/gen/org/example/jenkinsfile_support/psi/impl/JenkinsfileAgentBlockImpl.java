...
public class JenkinsfileAgentBlockImpl extends ASTWrapperPsiElement implements JenkinsfileAgentBlock {

  public JenkinsfileAgentBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JenkinsfileAgentSpec getAgentSpec() {
    return findNotNullChildByClass(JenkinsfileAgentSpec.class);
  }
