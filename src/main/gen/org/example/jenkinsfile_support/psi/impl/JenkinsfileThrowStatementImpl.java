...
public class JenkinsfileThrowStatementImpl extends ASTWrapperPsiElement implements JenkinsfileThrowStatement {

  public JenkinsfileThrowStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
