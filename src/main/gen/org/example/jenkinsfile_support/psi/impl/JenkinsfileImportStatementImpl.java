...
public class JenkinsfileImportStatementImpl extends ASTWrapperPsiElement implements JenkinsfileImportStatement {

  public JenkinsfileImportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
