...
public class JenkinsfileTestOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileTestOptions {

  public JenkinsfileTestOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitTestOptions(this);
  }
