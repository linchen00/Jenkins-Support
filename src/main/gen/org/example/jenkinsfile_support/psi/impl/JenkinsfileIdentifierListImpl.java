...
public class JenkinsfileIdentifierListImpl extends ASTWrapperPsiElement implements JenkinsfileIdentifierList {

  public JenkinsfileIdentifierListImpl(@NotNull ASTNode node) {
    super(node);
  }
