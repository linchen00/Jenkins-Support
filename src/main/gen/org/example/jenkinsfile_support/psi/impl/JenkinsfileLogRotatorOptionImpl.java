...
public class JenkinsfileLogRotatorOptionImpl extends ASTWrapperPsiElement implements JenkinsfileLogRotatorOption {

  public JenkinsfileLogRotatorOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitLogRotatorOption(this);
  }
