...
public class JenkinsfileMethodDeclarationImpl extends ASTWrapperPsiElement implements JenkinsfileMethodDeclaration {

  public JenkinsfileMethodDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
