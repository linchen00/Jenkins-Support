...
public class JenkinsfilePostConditionTypeImpl extends ASTWrapperPsiElement implements JenkinsfilePostConditionType {

  public JenkinsfilePostConditionTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitPostConditionType(this);
  }
