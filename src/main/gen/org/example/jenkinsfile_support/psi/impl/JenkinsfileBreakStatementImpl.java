...
public class JenkinsfileBreakStatementImpl extends ASTWrapperPsiElement implements JenkinsfileBreakStatement {

  public JenkinsfileBreakStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
