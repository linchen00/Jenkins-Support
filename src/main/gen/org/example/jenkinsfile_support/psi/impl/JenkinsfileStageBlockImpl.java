...
public class JenkinsfileStageBlockImpl extends ASTWrapperPsiElement implements JenkinsfileStageBlock {

  public JenkinsfileStageBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitStageBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileStageContent> getStageContentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileStageContent.class);
  }
