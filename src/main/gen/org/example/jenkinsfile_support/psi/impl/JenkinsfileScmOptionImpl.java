...
public class JenkinsfileScmOptionImpl extends ASTWrapperPsiElement implements JenkinsfileScmOption {

  public JenkinsfileScmOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitScmOption(this);
  }
