...
public class JenkinsfilePackageStatementImpl extends ASTWrapperPsiElement implements JenkinsfilePackageStatement {

  public JenkinsfilePackageStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JenkinsfileType getType() {
    return findNotNullChildByClass(JenkinsfileType.class);
  }
