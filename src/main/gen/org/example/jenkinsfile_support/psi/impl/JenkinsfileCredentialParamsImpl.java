...
public class JenkinsfileCredentialParamsImpl extends ASTWrapperPsiElement implements JenkinsfileCredentialParams {

  public JenkinsfileCredentialParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitCredentialParams(this);
  }
