...
public class JenkinsfileShParamsImpl extends ASTWrapperPsiElement implements JenkinsfileShParams {

  public JenkinsfileShParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitShParams(this);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileShOptions> getShOptionsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileShOptions.class);
  }
