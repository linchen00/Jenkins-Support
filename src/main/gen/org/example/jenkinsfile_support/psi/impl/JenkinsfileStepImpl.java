...
public class JenkinsfileStepImpl extends ASTWrapperPsiElement implements JenkinsfileStep {

  public JenkinsfileStepImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JenkinsfileStepExpression getStepExpression() {
    return findNotNullChildByClass(JenkinsfileStepExpression.class);
  }
