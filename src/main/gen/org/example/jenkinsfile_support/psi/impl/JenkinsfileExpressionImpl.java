...
public class JenkinsfileExpressionImpl extends ASTWrapperPsiElement implements JenkinsfileExpression {

  public JenkinsfileExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JenkinsfileConditionalExpression getConditionalExpression() {
    return findNotNullChildByClass(JenkinsfileConditionalExpression.class);
  }
