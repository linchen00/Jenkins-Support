...
public class JenkinsfileFieldDeclarationImpl extends ASTWrapperPsiElement implements JenkinsfileFieldDeclaration {

  public JenkinsfileFieldDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
