...
public class JenkinsfileAxisValueImpl extends ASTWrapperPsiElement implements JenkinsfileAxisValue {

  public JenkinsfileAxisValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitAxisValue(this);
  }
