...
public class JenkinsfileNumberExpressionImpl extends ASTWrapperPsiElement implements JenkinsfileNumberExpression {

  public JenkinsfileNumberExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
