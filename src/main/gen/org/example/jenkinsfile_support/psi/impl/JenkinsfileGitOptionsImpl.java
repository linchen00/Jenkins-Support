...
public class JenkinsfileGitOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileGitOptions {

  public JenkinsfileGitOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitGitOptions(this);
  }
