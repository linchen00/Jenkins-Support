...
public class JenkinsfileShOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileShOptions {

  public JenkinsfileShOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitShOptions(this);
  }
