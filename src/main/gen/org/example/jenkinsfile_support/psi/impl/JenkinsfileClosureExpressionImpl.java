...
public class JenkinsfileClosureExpressionImpl extends ASTWrapperPsiElement implements JenkinsfileClosureExpression {

  public JenkinsfileClosureExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JenkinsfileClosureBody getClosureBody() {
    return findNotNullChildByClass(JenkinsfileClosureBody.class);
  }

  @Override
  @Nullable
  public JenkinsfileClosureParameters getClosureParameters() {
    return findChildByClass(JenkinsfileClosureParameters.class);
  }
