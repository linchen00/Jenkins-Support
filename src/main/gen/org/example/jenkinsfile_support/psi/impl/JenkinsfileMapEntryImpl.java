...
public class JenkinsfileMapEntryImpl extends ASTWrapperPsiElement implements JenkinsfileMapEntry {

  public JenkinsfileMapEntryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JenkinsfileMapKey getMapKey() {
    return findNotNullChildByClass(JenkinsfileMapKey.class);
  }
