...
public class JenkinsfileSwitchStatementImpl extends ASTWrapperPsiElement implements JenkinsfileSwitchStatement {

  public JenkinsfileSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileSwitchBody> getSwitchBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileSwitchBody.class);
  }
