...
public class JenkinsfileWhenCrOptionsImpl extends ASTWrapperPsiElement implements JenkinsfileWhenCrOptions {

  public JenkinsfileWhenCrOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitWhenCrOptions(this);
  }
