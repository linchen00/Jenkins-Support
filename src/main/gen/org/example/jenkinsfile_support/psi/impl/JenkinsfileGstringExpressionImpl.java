...
public class JenkinsfileGstringExpressionImpl extends ASTWrapperPsiElement implements JenkinsfileGstringExpression {

  public JenkinsfileGstringExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getGstring() {
    return findNotNullChildByType(GSTRING);
  }
