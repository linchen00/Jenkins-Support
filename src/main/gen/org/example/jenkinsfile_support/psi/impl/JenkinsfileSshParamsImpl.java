...
public class JenkinsfileSshParamsImpl extends ASTWrapperPsiElement implements JenkinsfileSshParams {

  public JenkinsfileSshParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitSshParams(this);
  }
