...
public class JenkinsfileVariableDeclarationImpl extends ASTWrapperPsiElement implements JenkinsfileVariableDeclaration {

  public JenkinsfileVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
