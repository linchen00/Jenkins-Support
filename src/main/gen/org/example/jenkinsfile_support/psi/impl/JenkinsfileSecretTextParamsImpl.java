...
public class JenkinsfileSecretTextParamsImpl extends ASTWrapperPsiElement implements JenkinsfileSecretTextParams {

  public JenkinsfileSecretTextParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitSecretTextParams(this);
  }
