...
public class JenkinsfileReturnStatementImpl extends ASTWrapperPsiElement implements JenkinsfileReturnStatement {

  public JenkinsfileReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
