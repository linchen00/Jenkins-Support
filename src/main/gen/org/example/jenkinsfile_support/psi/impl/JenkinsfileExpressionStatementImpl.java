...
public class JenkinsfileExpressionStatementImpl extends ASTWrapperPsiElement implements JenkinsfileExpressionStatement {

  public JenkinsfileExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
