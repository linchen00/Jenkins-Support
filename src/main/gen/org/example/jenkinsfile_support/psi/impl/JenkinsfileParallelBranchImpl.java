...
public class JenkinsfileParallelBranchImpl extends ASTWrapperPsiElement implements JenkinsfileParallelBranch {

  public JenkinsfileParallelBranchImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitParallelBranch(this);
  }
