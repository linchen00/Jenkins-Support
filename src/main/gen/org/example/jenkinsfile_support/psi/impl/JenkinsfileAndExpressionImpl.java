...
public class JenkinsfileAndExpressionImpl extends ASTWrapperPsiElement implements JenkinsfileAndExpression {

  public JenkinsfileAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JenkinsfileEqualityExpression> getEqualityExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JenkinsfileEqualityExpression.class);
  }
