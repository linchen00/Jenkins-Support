...
public class JenkinsfileTimeoutStepImpl extends ASTWrapperPsiElement implements JenkinsfileTimeoutStep {

  public JenkinsfileTimeoutStepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitTimeoutStep(this);
  }
  ...
  public JenkinsfileTimeoutParams getTimeoutParams() {
    return findNotNullChildByClass(JenkinsfileTimeoutParams.class);
  }
