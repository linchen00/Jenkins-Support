...
public class JenkinsfileScriptBlockImpl extends ASTWrapperPsiElement implements JenkinsfileScriptBlock {

  public JenkinsfileScriptBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
