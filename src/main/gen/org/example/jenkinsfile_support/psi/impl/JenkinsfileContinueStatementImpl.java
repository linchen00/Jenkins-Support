...
public class JenkinsfileContinueStatementImpl extends ASTWrapperPsiElement implements JenkinsfileContinueStatement {

  public JenkinsfileContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
