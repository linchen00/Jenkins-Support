...
public class JenkinsfileWhenEnvironmentParamsImpl extends ASTWrapperPsiElement implements JenkinsfileWhenEnvironmentParams {

  public JenkinsfileWhenEnvironmentParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JenkinsfileVisitor visitor) {
    visitor.visitWhenEnvironmentParams(this);
  }
