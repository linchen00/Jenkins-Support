...
public class JenkinsfileNumberLiteralImpl extends ASTWrapperPsiElement implements JenkinsfileNumberLiteral {

  public JenkinsfileNumberLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
